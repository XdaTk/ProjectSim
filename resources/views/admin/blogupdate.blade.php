        ...
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-small-4-4">
                <div class="uk-panel uk-panel-box uk-panel-header">
                    <h3 class="uk-panel-title">修改文章</h3>
                    <form class="uk-form uk-form-stacked" method="post">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls">
                                <input type="text" name="title" id="form-h-it" class="uk-width-1-1" placeholder="标题" value="{{$blog->title}}">
                            </div>
                        </div>
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls">
                                <input type="text" name="brief" id="form-h-ip" class="uk-width-1-1" placeholder="简介" value="{{$blog->brief}}">
                            </div>
                        </div>
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls">
                                <select id="form-h-s" name="class_id" class="uk-width-1-1">
                                    @foreach($classifys as $classfiy)
                                        <option @if($blog->class_id==$classfiy->id) selected  @endif value="{{$classfiy->id}}">{{$classfiy->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="uk-form-controls">
                                <input id="form-h-s" type="hidden"   name="img" class="uk-width-1-1" value="{{$blog->url}}">
                            </div>
                        </div>
                        <div class="uk-form-row">
