                    ...
                    <form class="uk-form uk-form-stacked" method="post">
                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-form-controls">
                                <input type="text" name="name" id="form-h-it" class="uk-width-1-1" placeholder="名称"
                                       value="{{$inputs['name'] or ''}}">
                            </div>
                        </div>
                        <div class="uk-form-row">
                            <label class="uk-form-label" for="form-h-ip">URL</label>

                            <div class="uk-form-controls">
                                <input type="text" name="url" id="form-h-ip" class="uk-width-1-1" placeholder="URL"
                                       value="{{$inputs['url'] or ''}}">
                            </div>
                        </div>
                        <div class="uk-form-row">
                            <label class="uk-form-label" for="form-h-s">IMG</label>

                            <div class="uk-form-controls">
                                <input type="text" name="img" id="form-h-s" class="uk-width-1-1" placeholder="IMG"
                                       value="{{$inputs['img'] or ''}}">
                            </div>
                        </div>
                        @if (count($errors) > 0)
